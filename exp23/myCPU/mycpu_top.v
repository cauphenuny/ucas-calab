...
/************ sram axi bridge ************/
    ...
    sram_axi_bridge u_bridge(
        ...
        .data_rd_req(dcache_rd_req), .data_rd_type(dcache_rd_type), .data_rd_addr(dcache_rd_addr),
        .data_rd_rdy(dcache_rd_rdy),
        .data_ret_valid(dcache_ret_valid), .data_ret_last(dcache_ret_last), .data_ret_data(dcache_ret_data),
        .data_wr_req(dcache_wr_req), .data_wr_type(dcache_wr_type), .data_wr_addr(dcache_wr_addr),
        .data_wr_data(dcache_wr_data), .data_wr_wstrb(dcache_wr_wstrb), .data_wr_rdy(dcache_wr_rdy),
...
/**************** IF stage ****************/
    ...
    cache u_dcache(
        ...
        .valid(data_sram_req),
        .op(data_sram_wr),
        .index(data_vaddr[11:4]),
        .tag(data_paddr[31:12]),
